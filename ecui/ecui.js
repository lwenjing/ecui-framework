...
//{if 0}//
    ...
    document.write('<script type="text/javascript" src="combox.js"></script>');
    document.write('<script type="text/javascript" src="listbox.js"></script>');

    document.write('<script type="text/javascript" src="dialog.js"></script>');
    document.write('<script type="text/javascript" src="tree-view.js"></script>');
    document.write('<script type="text/javascript" src="month-view.js"></script>');
    document.write('<script type="text/javascript" src="tab.js"></script>');
    document.write('<script type="text/javascript" src="progress.js"></script>');
    ...
    document.write('<script type="text/javascript" src="decorate.js"></script>');
    document.write('<script type="text/javascript" src="esr.js"></script>');
    document.write('<script type="text/javascript" src="etpl.js"></script>');
//{/if}//
